    ...
    data: [
      {
        familyId: family.id,
        propertyId: chalet.id,
        name: "Annual home insurance - Chalet",
        amount: 1200,
        recordType: "EXPENSE",
        date: new Date("2026-01-15"),
        tags: [{ id: chalet.id, label: "Chalet Montagne", type: "property" }],
        createdBy: massimo.id,
      },
      {
        familyId: family.id,
        propertyId: apartment.id,
        name: "March rent from tenant",
        amount: 2500,
        recordType: "INCOME",
        date: new Date("2026-03-01"),
        tags: [{ id: apartment.id, label: "Appartement Lyon", type: "property" }],
        createdBy: sophie.id,
      },
      {
        familyId: family.id,
      ...
      },
      {
        ...
        tags: [{ id: chalet.id, label: "Chalet Montagne", type: "property" }],
        notes: "Called plumber for burst pipe in bathroom",
        createdBy: massimo.id,
      },
      {
        familyId: family.id,
        propertyId: villa.id,
        name: "March garden maintenance",
        amount: 180,
        recordType: "EXPENSE",
        date: new Date("2026-03-10"),
        tags: [{ id: villa.id, label: "Villa Méditerranée", type: "property" }],
        createdBy: massimo.id,
      },
      {
        familyId: family.id,
        propertyId: apartment.id,
        name: "Property tax 2026",
        amount: 3500,
        recordType: "EXPENSE",
        date: new Date("2026-04-15"),
        tags: [{ id: apartment.id, label: "Appartement Lyon", type: "property" }],
        notes: "Annual property tax due",
        createdBy: massimo.id,
      },
      {
        familyId: family.id,
        propertyId: chalet.id,
        name: "Electricity Jan-Mar",
        amount: 320,
        recordType: "EXPENSE",
      ...
      },
      {
        familyId: family.id,
        propertyId: villa.id,
        name: "Annual home insurance - Villa",
        amount: 1800,
        recordType: "EXPENSE",
      ...
      },
      {
        familyId: family.id,
        propertyId: apartment.id,
        name: "April rent expected",
        amount: 2500,
        recordType: "INCOME",
        date: new Date("2026-04-01"),
        tags: [{ id: apartment.id, label: "Appartement Lyon", type: "property" }],
        notes: "Tenant confirmed payment",
        createdBy: sophie.id,
      },
    ],
  });
